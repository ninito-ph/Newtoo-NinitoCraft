...
for %%i in (purpur*.jar) do (
  echo Using '%%i' as the server .jar file.
  set jarfile=%%i
)

set /p ram="Enter the desired RAM amount in gigabytes (Leave empty for 8): "
if "%ram%" == "" set ram=8
echo Starting server with %ram%G of RAM...
